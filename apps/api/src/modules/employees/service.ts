...
export class EmployeeService {
  ...
  static async resolveEmployeeForUser(userId: string, userName: string, userEmail: string) {
    ...
    // Fallback based on name has been removed to prevent auto-relinking after manual unlink.
    // Users must manually link their employee data via NIP in the profile.
    return null;
  }
