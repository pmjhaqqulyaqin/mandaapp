...
const ALL_MENU_KEYS = [
  ...
  "gallery", "contacts", "pages", "menus", "settings", "users", "updates", "e-office", "ptsp", "exams", "ppdb", "penilaian-pmb", "ijazah", "attendance", "jurnal", "kbm", "alumni", "mutasi"
];

const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  admin: ALL_MENU_KEYS,
  kepala_madrasah: ["overview", "news", "calendar", "teacher-duties", "student-card", "students", "buku-induk", "classes", "employees", "gallery", "contacts", "e-office", "exams", "ppdb", "penilaian-pmb", "ijazah", "attendance", "jurnal", "kbm", "alumni", "mutasi"],
  wakil_kepala: ["overview", "news", "calendar", "teacher-duties", "student-card", "students", "buku-induk", "classes", "employees", "gallery", "contacts", "e-office", "exams", "ppdb", "penilaian-pmb", "ijazah", "attendance", "jurnal", "kbm", "alumni", "mutasi"],
  ...
  kepala_tu: ["overview", "news", "calendar", "teacher-duties", "student-card", "students", "buku-induk", "classes", "employees", "gallery", "contacts", "e-office", "exams", "ppdb", "penilaian-pmb", "ijazah", "attendance", "jurnal", "kbm", "alumni", "mutasi"],
  pegawai_tu: ["overview", "news", "calendar", "teacher-duties", "student-card", "students", "buku-induk", "employees", "e-office", "ppdb", "penilaian-pmb", "ijazah", "attendance", "kbm", "alumni", "mutasi"],
  operator: ["overview", "news", "calendar", "teacher-duties", "student-card", "students", "buku-induk", "employees", "gallery", "e-office", "ppdb", "penilaian-pmb", "ijazah", "attendance", "kbm", "alumni", "mutasi"],
};
