...
export const ALL_MENU_ITEMS = [
  ...
  },
  {
    ...
    group: 'main',
    subItems: [
      { key: 'input-nilai', label: 'Input Nilai Sumatif', href: '/dashboard/rapor', exact: true, icon: <FileSpreadsheet size={16} /> },
      { key: 'tp', label: 'Tujuan Pembelajaran', href: '/dashboard/rapor/tp', icon: <BookOpen size={16} /> },
      { key: 'config', label: 'Konfigurasi Bobot', href: '/dashboard/rapor/config', icon: <SettingsIcon size={16} /> },
    ],
  },
  {
    key: 'nis',
...
export const MENU_ICON_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  'rapor':         { bg: 'bg-gradient-to-br from-emerald-500 to-teal-600',    text: 'text-white' },
...
export const MOBILE_MENU_SECTIONS = [
  ...
  { title: 'Layanan', keys: ['ptsp', 'exams', 'ijazah', 'rapor'] },
];
