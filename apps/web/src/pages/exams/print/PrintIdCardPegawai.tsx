    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center pt-3 pb-2 px-2.5">
          ...
          {/* Photo Frame — object-cover fills frame, object-position 25% keeps face/head area visible */}
          <div className="w-[3cm] h-[4cm] bg-gray-100 mt-2 mb-2 rounded-[8px] overflow-hidden border-[3px] border-white shadow-md relative z-20 flex-shrink-0">
            <img src={photoSrc} className="w-full h-full object-cover" style={{ objectPosition: 'center 25%' }} alt="Pegawai" loading="eager" />
          </div>
