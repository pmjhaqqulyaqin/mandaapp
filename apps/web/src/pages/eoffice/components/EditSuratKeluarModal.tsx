...
interface EditSuratKeluarModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  surat: any | null;
...
export const EditSuratKeluarModal = ({ isOpen, onClose, onSuccess, surat }: EditSuratKeluarModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await apiClient(`/eoffice/surat-keluar/${surat.id}`, { method: 'PUT', data: formData });
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
          <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Edit Data Surat Keluar</h3>
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          <form id="edit-keluar-form" onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="transition-all">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tujuan</label>
              <input 
                type="text"
