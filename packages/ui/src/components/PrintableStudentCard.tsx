...
export const PrintableStudentCard = ({
  ...
  const VerticalBack = () => {
    ...
    return (
      <div style={{ width: '100%', height: '100%', position: 'relative', backgroundColor: '#fcfcfc', display: 'flex', flexDirection: 'column' }}>
        {/* HEADER */}
        <div style={{ width: '100%', height: '180px', backgroundColor: headerColor, borderBottomLeftRadius: '10px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', zIndex: 10, flexShrink: 0 }}>
           {/* Yellow Top Pill */}
           <div style={{ position: 'absolute', top: 0, left: 0, width: '140px', height: '24px', backgroundColor: '#facc15', borderBottomRightRadius: '12px' }}></div>
        ...
        {/* BODY (Terms & QR) */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', padding: '30px 40px' }}>
        ...
        {/* FOOTER */}
        <div style={{ margin: '15px 25px 30px 25px', padding: '15px 20px', backgroundColor: headerColor, borderRadius: '15px', display: 'flex', justifyContent: 'center', gap: '30px', color: 'white', alignItems: 'center', zIndex: 10 }}>
